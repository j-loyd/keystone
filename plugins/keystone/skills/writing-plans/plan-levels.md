...
| ---------------------- | ------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Spec**               | inline one-liner, no sharpening                                    | clarify only if fuzzy                                                                                                                       | mandatory sharpening (`office-hours` and/or `grill-with-docs`; `llm-security` + `cost-aware-llm-pipeline` if LLM/agent work; `research-notes` for novel domains)  |
